...
export async function POST(request: NextRequest) {
    try {
        ...
        const response = await fetch(`${NEXT_PUBLIC_SERVER_URI}/tickets/pending?page=${page}&limit=${limit}&filters=${encodeURIComponent(filters)}`, {
            method: 'GET',
            headers: {
        ...
        console.log("[TICKET-PENDING-LIST]", error);
