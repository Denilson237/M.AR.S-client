...
const data = await request.json();
    ...
    try {
        ...
        const response = await fetch(`${NEXT_PUBLIC_SERVER_URI}/requests/unassignments?page=${page}&limit=${limit}&filters=${encodeURIComponent(filters)}`, {
            method: 'GET',
            headers: {
        ...
        console.log("[REQUEST-ELIBIBLE-UNASSIGNMENT]", error);
